                                ...
                                <Row>
                                    <Col>
                                        <div className="mb-3">
                                            ...
                                            <Select id={`contact_role_${key}`} name="contact_role" isClearable={true} className="basic-single" classNamePrefix="select"
                                                options={contactRoles} onChange={(e) => {
                                                    setInputFields(prev => {
                                                        const updated = [...prev]; // copy array
                                                        updated[key] = {
                                                            ...updated[key], // keep other fields in that row
                                                            contact_role: e.value,
                                                            contact_name: "" // reset contact name
                                                        };
                                                        return updated;
                                                    });
                                                }}
                                    ...
                                    <Col>
                                        <div className="mb-3">
                                            ...
                                            <input type="text" name="contact" className="form-control" placeholder="Select Contact" onChange={(e) => {
                                                setInputFields(prev => {
                                                    const updated = [...prev];
                                                    updated[key] = {
                                                        ...updated[key],
