                ...
                <Row>
                    <Col>
                        <div className="d-flex align-items gap-3 mb-2">
                            <AllButton
                                label="Seller"
                                className={activeSeller === "Seller" ? "allbutton-wrapper active" : "allbutton-wrapper"}
                                onClick={() => setActiveSeller("Seller")}
                            />
                            <AllButton
                                label="Buyer"
                                className={activeSeller === "Buyer" ? "allbutton-wrapper active" : "allbutton-wrapper"}
                                onClick={() => setActiveSeller("Buyer")}
                            />
                            <AllButton
                                label="Both"
                                className={activeSeller === "Both" ? "allbutton-wrapper active" : "allbutton-wrapper"}
                ...
                <Row>
                    <Col>
                        <div className="d-flex align-items gap-3 mb-2">
                            <AllButton
                                label="Landlord"
                                className={activeLandlord === "Landlord" ? "allbutton-wrapper active" : "allbutton-wrapper"}
                                onClick={() => setActiveLandlord("Landlord")}
                            />
                            <AllButton
                                label="Tenant"
                                className={activeLandlord === "Tenant" ? "allbutton-wrapper active" : "allbutton-wrapper"}
                                onClick={() => setActiveLandlord("Tenant")}
                            />
                            <AllButton
                                label="Both"
                                className={activeLandlord === "Both" ? "allbutton-wrapper active" : "allbutton-wrapper"}
