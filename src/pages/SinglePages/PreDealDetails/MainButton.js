        ...
        <>
            <div className="d-flex justify-content-center gap-2 w-100">
                <Link to="/deals" style={{ textDecoration: "none" }}>
                    <CheckButton label="Open Executed Deal" outline={false} width="180px" />
                </Link>
                <EmailButton label="Compose Email" width="170px" onClick={(e) => { e.stopPropagation(); setModalOpen(true) }} />
                <FileSignatureButton label="Submit Offer to LA" width="170px" onClick={() => console.log('Button Clicked')} />
